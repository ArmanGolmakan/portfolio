  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-[48%] lg:flex-col lg:justify-between lg:py-24">
            ...
            {navItems.map(({ label, href }) => {
              ...
              return (
                <li key={label}>
                  ...
                  >
                    <span
                      className={`inline-block h-px transition-all duration-200 group-hover:w-16 group-hover:bg-slate-lightest ${
                        isActive
      ...
      <ul className="ml-1 mt-8 flex items-center gap-5 lg:mt-0">
        <li>
          <a
            href="https://github.com/ArmanGolmakan"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="text-slate transition-colors duration-200 hover:text-teal"
          >
            <svg
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/arman1996/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-slate transition-colors duration-200 hover:text-teal"
        ...
        <li>
          <a
            href="https://www.instagram.com/arman9g/"
            target="_blank"
            rel="noopener noreferrer"
